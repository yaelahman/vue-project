              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="dt-overtime" class="display nowrap w-100">
                      ...
                      <tbody>
                        ...
                        >
                          ...
                          <td>
                            <div
                              v-html="mapStatus(val.t_absensi_status_admin)"
                            ></div>
                          </td>
                          <td class="text-start">
                            <div class="btn-group">
                              ...
                              <button
                                v-if="val.t_absensi_catatan != null"
                                type="button"
                                class="btn btn-sm btn-light"
                                data-bs-toggle="modal"
                              ...
                              <div
                                v-if="val.t_absensi_status_admin == 0"
...
export default {
  ...
  methods: {
    ...
    overtimeApprove(type = null) {
      ...
      // $('.btn-submit').attr('disabled', true)
      axios
        .post(env.VITE_API_URL + "overtime/approve", this.data)
        .then((response) => {
          this.loadAbsensiLembur();
    ...
    filterRangeDate() {
      if (this.filterType == "show") {
        ...
        Swal.fire({
          title: "Ekspor Lembur",
          text:
            "Ingin Ekspor Lembur Dengan Tanggal " +
