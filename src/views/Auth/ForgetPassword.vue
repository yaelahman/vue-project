        ...
        <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
            ...
            <div class="app-auth-container" style="overflow: scroll;">
                <div style="margin: 5rem;">
                    <div v-if="success" class="border-home" style="padding-top: 12rem; padding-bottom: 12rem;">
                        <div class="logo">
                        ...
                        <h4 class="mb-3 mt-4" style="color: #34B1E8;"><b>Reset password</b></h4>

                        <div class="">
                            <p>Silahkan cek email anda untuk reset password.</p>

                            <div class="auth-submit row d-flex justify-content-between">
                                <div class=" col-lg-12 col-sm-12 pt-3">
                                    <a href="/login" style="color: #34B1E8; ">Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div v-else class="border-home" style="padding-top: 8rem; padding-bottom: 8rem;">
                        <div class="logo">
                            <svg width="30" height="30" viewBox="0 0 50 50" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <form @submit.prevent="prosesLogin">
                            ...
                            <div class="">
                                <p>Silahkan masukkan email untuk reset password.</p>
                                ...
                                <div class="auth-submit row d-flex justify-content-between">
                                    ...
                                    <div class="col-lg-8 col-sm-12">
                                        <button type="submit" id="submit" class="btn btn-primary w-100"
                                            style="border-radius: 30px; ">Kirim link</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="mt-3 d-flex justify-content-center ">
                        <p style="color: #34B1E8; ">Belum punya akun?
                            <router-link to="/register"><b>Registrasi</b></router-link>
                        </p>
                    </div>
                </div>
            </div>
...
export default {
    ...
    mounted() {
        if (this.$route.query.verified_mail) {

            if (this.$route.query.verified_mail == 'true') {
                Toast.fire({
                    icon: 'success',
                    title: 'Verifikasi Email Berhasil, Silahkan Login'
                })
            } else {
                Toast.fire({
                    icon: 'error',
    ...
    methods: {
        ...
        async prosesLogin() {
            ...
            $("#submit").html("Loading...");
            await axios
                .post(env.VITE_API_URL + "forgot-password", this.auth)
                .then((response) => {
