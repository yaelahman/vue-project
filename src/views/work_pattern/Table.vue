                ...
                <table id="dt-1" class="display w-100 dataTable no-footer" style="width: 100%;"
                    ...
                    <tbody v-if="!isLoading">
                        <tr v-for="(val, index) in data.data" :key="index" class="odd">
                            ...
                            <td>{{ val.w_p_d_kerja_count }} Hari</td>
                            <td>{{ val.w_p_d_libur_count }} Hari</td>
                            <td>
                                {{ val.m_work_patern_tolerance }} Menit
                            </td>
                            <td>
                                {{ val.work_personel_count }}
                            </td>
