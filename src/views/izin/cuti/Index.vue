                            ...
                            <div class="card">
                                    ...
                                    <form @submit.prevent="filterRangeDate()">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-4 col-12 d-flex" style="margin-top: 1.8rem;">
                                                <button class="btn btn btn-sm text-nowrap btn-primary mb-2 me-2" 
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="dt-cuti" class="display nowrap w-100">
        ...
        filterRangeDate() {
            if (this.filterType == 'show') {
                ...
                Swal.fire({
                    ...
                    if (resp.isConfirmed) {
                        axios.get(`${env.VITE_API_URL}/exports/izin/3?start_date=${this.search.startDate}&end_date=${this.search.endDate}&status=${this.search.status}`).then((resp) => {
                            if (resp.status == 200) {
            ...
            axios
                ...
                .then((response) => {
                    if (Api.response(response.data, false) === Api.STATUS_SUCCESS) {
                        ...
                        this.table.destroy();
                        this.$nextTick(() => {
                            this.table = $("#dt-cuti").DataTable({ autoWidth: false });
                        });
                    }
                })
                .catch((e) => {
