                                    ...
                                    <form @submit.prevent="filterRangeDate()">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-4 col-12 d-flex" style="margin-top: 1.8rem;">
                                                <button class="btn btn-sm text-nowrap btn-primary mb-2 me-2"
            ...
            if (this.filterType == 'show') {
                ...
                Swal.fire({
                    ...
                    if (resp.isConfirmed) {
                        ...
                        axios.get(`${env.VITE_API_URL}/exports/izin/1?start_date=${this.search.startDate}&end_date=${this.search.endDate}&status=${this.search.status}`).then((resp) => {
                            if (resp.status == 200) {
