                            ...
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    <div class="form-group">
                                        <div class="mt-3">
                                            <router-link to="/izin-jam" class="btn btn-light">
                                ...
                                <div class="card-body py-3">
                                    ...
                                    <div class="row row-cols-2">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    :value="convertDate(permit.permit_startclock)" required disabled>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    :value="convertDate(permit.permit_startclock, 'HH:mm')" required
                                                    disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row row-cols-2">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    :value="convertDate(permit.permit_endclock)" required disabled>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    :value="convertDate(permit.permit_endclock, 'HH:mm')" required
                                                    disabled>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" :value="jumlahJam(permit)" required
                                            disabled>
                                    </div>
                                    <div class="form-group">
